...
<form method="post" action="edit_post.php?edit_form=<?php echo $post_id ?>" enctype="multipart/form-data">
	<table width="600" bgcolor="orange" align="center" border="10">
		...
		<tr>
			...
			<td><input type="text" name="title" size="20"value="<?php echo $post_title; ?>"></td>
		</tr>
		
		<tr>
			<td align="right">Post Author:</td>
			<td><input type="text" name="author" size="20"value="<?php echo $post_author; ?>"></td>
		</tr>
		
		<tr>
			<td align="right">Post Keywords:</td>
			<td><input type="text" name="keywords" size="20" value="<?php echo $post_keywords; ?>"></td>
		</tr>
		<tr>
...
<?php 
	...
	$post_title1 = mysqli_real_escape_string($con,$_POST['title']);
		$post_date1 = date('m-d-y');
		$post_author1 = mysqli_real_escape_string($con,$_POST['author']);
		$post_keywords1 = mysqli_real_escape_string($con,$_POST['keywords']);
	...
	$post_keywords1=='' or $post_content1==''){
		...
		if($post_image1){
			...
			$image_data = ",post_image='$post_image1'";
		}else{
			$image_data = "";
		}
		
		echo $update_query = "update posts set post_title='$post_title1',post_date='$post_date1',post_author='$post_author1'$image_data,post_keywords='$post_keywords1',post_content='$post_content1' where post_id=$update_id ";
		//echo $update_query;
		//exit;
